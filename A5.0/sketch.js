...
var Particle = function(position) {
  this.acceleration = createVector(0, second()/20);
  this.velocity = createVector(random(-second()/5, second()/5), random(-1, 0));
  this.position = position.copy();
  this.lifespan = second()*4;
};
...
Particle.prototype.display = function () {
  stroke(20, 100, 80, this.lifespan);
  strokeWeight(hour());
  fill(20, 100, 80, this.lifespan);
